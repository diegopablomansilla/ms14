...
public class CentroCostoContableDAO extends AbstractDAO {

	private SourceSQL sourceSQL;

	// ---------------------------------------------------------------------------------------------------------------------------

	public CentroCostoContableDAO(SourceSQL sourceSQL) {
		super();
	...
	private List<CentroCostoContable> buildObjsQ1(Result r) {
		...
		for (Object[] row : r.getTable()) {
			...
			CentroCostoContable objRow = new CentroCostoContable();
