...
public class AsientoContableModuloDAO extends AbstractDAO {

	private SourceSQL sourceSQL;

	// ---------------------------------------------------------------------------------------------------------------------------

	public AsientoContableModuloDAO(SourceSQL sourceSQL) {
		super();
	...
	public Integer count(ConnectionWrapper connection, AsientoContableModuloFilterQ1 filter)
		...
		String sql = this.sourceSQL.get("AsientoContableModulo_q1");
	...
	public List<AsientoContableModulo> find(ConnectionWrapper connection, AsientoContableModuloFilterQ1 filter)
			throws SelectException, SQLException {
	...
	private List<AsientoContableModulo> buildObjsQ1(Result r) {
		
		List<AsientoContableModulo> items = new ArrayList<AsientoContableModulo>();
		...
		for (Object[] row : r.getTable()) {
			...
			AsientoContableModulo objRow = new AsientoContableModulo();
