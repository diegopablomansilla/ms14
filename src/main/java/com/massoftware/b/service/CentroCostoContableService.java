...
public class CentroCostoContableService {
	...
	public CentroCostoContableService(String dataBaseKey) {
		super();
	...
	public Integer count(CentroCostoContableFilterQ1 filter) throws Exception500 {
	...
	public CentroCostoContable findById(String id) throws Exception500 {
		try {
		...
		CentroCostoContableFilterQ1 filter = new CentroCostoContableFilterQ1();
		filter.setId(id);

		List<CentroCostoContable> items = find(filter);
	...
	public List<CentroCostoContable> find(CentroCostoContableFilterQ1 filter) throws Exception500 {
	...
	public boolean deleteById(String id) throws Exception500 {
		...
		try {					
			...
			boolean b = dataBase.deleteObjectById(id, CentroCostoContable.class);
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo borrar el " + CentroCostoContable.class.getCanonicalName() + " " + id);
			}
	...
	public CentroCostoContable update(CentroCostoContable obj) throws Exception500 {
		...
		try {			
			...
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo actualizar el " + CentroCostoContable.class.getCanonicalName() + " " + obj.getId());
			}
	...
	public CentroCostoContable save(CentroCostoContable obj) throws Exception500 {
		try {
			Objects.requireNonNull(obj, "obj is null!!");
		} catch (Exception e) {
			throw new Exception500(e);
	...
	public CentroCostoContable insert(CentroCostoContable obj) throws Exception500 {
