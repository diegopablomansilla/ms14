...
public class AsientoModeloItemService {
	...
	public AsientoModeloItemService(String dataBaseKey) {
		super();
	...
	public Integer count(AsientoModeloItemFilterQ1 filter) throws Exception500 {		
	...
	public AsientoModeloItem findById(String id) throws Exception500 {
		try {
		...
		AsientoModeloItemFilterQ1 filter = new AsientoModeloItemFilterQ1();
		filter.setId(id);

		List<AsientoModeloItem> items = find(filter);
	...
	public List<AsientoModeloItem> find(AsientoModeloItemFilterQ1 filter) throws Exception500 {
	...
	public boolean deleteById(String id) throws Exception500 {		
		...
		try {
			...
			boolean b = dataBase.deleteObjectById(id, AsientoModeloItem.class);
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo borrar el " + AsientoModeloItem.class.getCanonicalName() + " " + id);
			}
	...
	public AsientoModeloItem update(AsientoModeloItem obj) throws Exception500 {
		...
		try {
			...
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo actualizar el " + AsientoModeloItem.class.getCanonicalName() + " " + obj.getId());
			}
