...
public class AsientoContableItemService {
	...
	public AsientoContableItemService(String dataBaseKey) {
		super();
	...
	public Integer count(AsientoContableItemFilterQ1 filter) throws Exception500 {		
	...
	public AsientoContableItem findById(String id) throws Exception500 {
		try {
		...
		AsientoContableItemFilterQ1 filter = new AsientoContableItemFilterQ1();
		filter.setId(id);

		List<AsientoContableItem> items = find(filter);
	...
	public List<AsientoContableItem> find(AsientoContableItemFilterQ1 filter) throws Exception500 {
	...
	public boolean deleteById(String id) throws Exception500 {		
		...
		try {
			...
			boolean b = dataBase.deleteObjectById(id, AsientoContableItem.class);
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo borrar el " + AsientoContableItem.class.getCanonicalName() + " " + id);
			}
	...
	public AsientoContableItem update(AsientoContableItem obj) throws Exception500 {
		...
		try {
			...
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo actualizar el " + AsientoContableItem.class.getCanonicalName() + " " + obj.getId());
			}
