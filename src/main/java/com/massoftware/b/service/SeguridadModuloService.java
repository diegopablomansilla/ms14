...
public class SeguridadModuloService {
	...
	public SeguridadModuloService(String dataBaseKey) {
		super();
	...
	public Integer count(SeguridadModuloFilterQ1 filter) throws Exception500 {		
	...
	public SeguridadModulo findById(String id) throws Exception500 {
		try {
		...
		SeguridadModuloFilterQ1 filter = new SeguridadModuloFilterQ1();
		filter.setId(id);

		List<SeguridadModulo> items = find(filter);
	...
	public List<SeguridadModulo> find(SeguridadModuloFilterQ1 filter) throws Exception500 {
	...
	public boolean deleteById(String id) throws Exception500 {		
		...
		try {
			...
			boolean b = dataBase.deleteObjectById(id, SeguridadModulo.class);
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo borrar el " + SeguridadModulo.class.getCanonicalName() + " " + id);
			}
	...
	public SeguridadModulo update(SeguridadModulo obj) throws Exception500 {
		...
		try {
			...
			if (b == false) {
				throw new IllegalStateException(
						"No se pudo actualizar el " + SeguridadModulo.class.getCanonicalName() + " " + obj.getId());
			}
