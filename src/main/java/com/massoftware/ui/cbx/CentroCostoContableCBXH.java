...
public class CentroCostoContableCBXH extends HorizontalLayout {

	public CentroCostoContableCBX cbx;
	public Button buttonOpen;

	public CentroCostoContableCBXH(CentroCostoContableCBX cbx) {
